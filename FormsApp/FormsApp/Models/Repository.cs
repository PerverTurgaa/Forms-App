namespace FormsApp.Models
{
    public class Repository
    {
        ...
        // private üye var, bunu dışarı açmak istediğimde sadece Products ı açıyorum
        // ekleme çıkaarma yapamıyoum çünkü set yok şuan
        // set gerektiğinde metotla yapılcak
        ...
        static Repository()
        {
            ...
            _products.Add(new Product { ProductId = 3, Name = "Macbook Air", Price = 80000, IsActive = true, Image = "5.jpg", CategoryId = 2 });
            _products.Add(new Product { ProductId = 4, Name = "Macbook Prp", Price = 90000, IsActive = false, Image = "6.jpg", CategoryId = 2 });
        }
